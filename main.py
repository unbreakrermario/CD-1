...
input_data = normalized_data["BMI"]
output_data = normalized_data["Y"]

training, test = proc.split_data(normalized_data, 0.7)
training_input = training["BMI"]
training_output = training["Y"]
test_input = training["BMI"]
test_output = training["Y"]
...
R2 = proc.get_coefficient_determination(test_output, test_predictions)
print("R² Score: ", R2)
